...
public interface Request {
	 ...
	 * 
	 * @return a {@link org.jogger.http.Request.BodyParser} implementation.
	 */
	BodyParser getBody();
	
	/**
	 * This is what we returned when the {@link org.jogger.http.Request#getBody()} is called. Provides convenient methods to parse the
	 * request body.
	 * 
	 * @author German Escobar
	 */
